...
ghc exec -- clap install "https://github.com/suzuki-shunsuke/run-ci/releases/download/${RUN_CI_VERSION}/run-ci_${RUN_CI_VERSION##v}_linux_amd64.tar.gz" run-ci:/usr/local/bin/run-ci 
